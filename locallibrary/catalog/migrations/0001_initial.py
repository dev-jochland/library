    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_cover', models.ImageField(upload_to=catalog.models.user_directory_path)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['due_back'],
                'permissions': (('can_mark_returned', 'Set book as returned'), ('can_renew', 'Renew date for books on loan'), ('can_borrow', 'Users can make a borrow request')),
            },
        ),
        migrations.AddField(
            model_name='book',
